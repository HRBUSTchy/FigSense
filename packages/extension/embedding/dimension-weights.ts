...
const FEATURE_WEIGHT_OVERRIDES: WeightByDimension = {
  ...Object.fromEntries(LAYOUT_DIMENSION_KEYS.map((key) => [key, 1.5])),
  'layout_mode:NONE': 0.9,
  'layout_mode:HORIZONTAL': 2.0,
  'layout_mode:VERTICAL': 1.05,
  'layout_mode:GRID': 0.9,
  'layout_align:MIN': 0.95,
  'layout_align:CENTER': 1.05,
  'layout_align:MAX': 1.05,
  'layout_align:SPACE_BETWEEN': 2.0,
  'layout:item_spacing': 1.2,
  'layout:child_horizontal_bias': 0.65,
  'layout:child_horizontal_flag': 0.65,
